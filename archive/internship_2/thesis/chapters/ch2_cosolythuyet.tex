...
điểm công bố $z_1, \dots, z_T$. Tấn công Bayes \emph{tối ưu} là chuẩn lý thuyết
(\cite{shokri2011quantifying}); hiện thực đánh giá của luận văn
(Chương~\ref{ch:thucnghiem}) dùng một adversary \emph{emission dạng-REM} --- tối
ưu cho REM, nhưng chỉ là \emph{proxy} cho các cơ chế phụ thuộc lịch sử/trạng thái
(T-REM/SM-REM/PR-SM-REM) --- ở hai hiện thân: suy luận từng điểm và tấn công theo
dõi HMM khai thác tương quan thời gian~\cite{xiao2015protecting}. Vì là proxy, số
liệu attacker cho cơ chế non-REM là cận trên và không dùng để xếp hạng riêng tư.

...
duyệt) kết hợp lưới đường với tương quan thời gian. Đặc biệt gần với SM/PR-SM-REM
là \textbf{Simitçioğlu \& Gürsoy}~\cite{simitcioglu2026continuous} (Computer
Networks 2026): họ hình thức hóa cùng cách chia mối đe dọa (Bayesian cho người
dùng \emph{tĩnh}, HMM cho người dùng \emph{di chuyển}) và đề xuất ba defense
\emph{Memoization / Replay / Replication} --- Replication reuse bản nhiễu trước
khi vị trí lặp lại, rất giống ý tưởng reuse của luận văn. Khác biệt cốt lõi: họ
làm trên \emph{categorical LDP protocols}, còn luận văn làm trên \emph{metric-space
Geo-I road-constrained}. Vì vậy đóng góp của luận văn được định vị hẹp là
\textbf{tích hợp + hình thức hóa + đánh giá memoization/predictive-reuse trong
bối cảnh lưới đường}, không phải phát minh bản thân memoization/reuse; so sánh
thực thi có căn chỉnh với các defense trên là hướng phát triển.

...
import folium
import numpy as np
from archive.internship_2.apps.core.trajectory_privacy import TrajectoryPrivacy
import os
import datetime
import random
import osmnx as ox
...
def main():
    ...
    output_dir = os.path.join("archive", "internship_2", "demo_outputs")
    os.makedirs(output_dir, exist_ok=True)
    output_file = os.path.join(
        output_dir, f"trajectory_privacy_map_{timestamp}.html"
    )

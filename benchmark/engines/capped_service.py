...
class CappedServiceLaneDummy(PacedSlackProgressLaneDummy):
    ...
    index_class = CappedServiceIndex
    objective_class = CappedServiceObjective
    ...
    def __init__(self, rn, *, location_service_cap=.9, **kwargs):
        ...
        self.capped_index = (self.index_class(context.signatures, context.access, self.belief_model.poi_weights)
    ...
    def postprocess(self, anchor, timestamp_s):
        ...
        context = self.belief_model.context
        objective = self.objective_class(self.capped_index, belief, self.location_service_cap)

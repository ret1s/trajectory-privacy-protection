...
Source & commit \texttt{253001ecfa17}; source tree sạch trước khi chạy \\
...
Sau khi bổ sung provenance và kiểm tra ranh giới active/archive, toàn bộ suite có
\textbf{124 test pass, 0 fail}. Test bao phủ công thức/candidate ordering, VTGA
stages, semantic primitives, deterministic seed, directed graph, semantic hash,
protocol invariants, truth separation, artifact schema, endpoint security và cấu
trúc kho mã. Đây là verification phần mềm, không thay thế validation khoa học.
...
latexmk -cd -xelatex -interaction=nonstopmode -halt-on-error \
  -outdir=../build/thesis thesis/main.tex
\end{verbatim}

Canonical run được sinh từ source tree sạch ở commit:

\noindent\small\path{253001ecfa17e1f1118fcf04a786a18146dd6a8e}\normalsize
...
\begin{itemize}
  ...
  \item \path{artifacts/benchmarks/dummy_benchmark_results.json};
  \item \path{artifacts/benchmarks/dummy_benchmark_map.html};
  \item \path{artifacts/benchmarks/dummy_benchmark_preview.png};
...
\begin{itemize}
  ...
  \item JSON canonical:\newline
        \small\path{08464467aea15a0f22346d4256c203ba7590e3638e0a00adcc58333ea893e880}\normalsize;
  \item map HTML:\newline
        \small\path{f0f2dc168737560dbaa55e3bc5d37a24c93f284e0c80e033b7c499ef85524594}\normalsize;
  \item preview PNG:\newline

...
\begin{itemize}
  ...
  một chỗ luôn trả về cùng một điểm công bố --- đóng tấn công averaging tại
  stay-point (khôi phục địa chỉ nhà), rủi ro thực tế nghiêm trọng nhất mà các
  cơ chế nhiễu độc lập đều bỏ ngỏ.
\end{itemize}
...
\begin{enumerate}
  ...
  \item Ba cơ chế REM, T-REM và SM-REM kèm chứng minh đảm bảo riêng tư
  (Mục~\ref{sec:rem}, \ref{sec:trem}, \ref{sec:smrem});
  \item Bộ khung đánh giá theo chuẩn văn liệu: tấn công suy luận Bayes tối ưu,
  tấn công theo dõi HMM, và tấn công averaging tại stay-point, cùng các độ đo
  tiện ích và tính thực tế (Chương~\ref{ch:thucnghiem});

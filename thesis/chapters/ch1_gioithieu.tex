...
\begin{itemize}
  ...
  revisit) bằng \emph{phép thử reuse có nhiễu} (kiểu predictive mechanism +
  w-event), đạt đảm bảo \emph{trajectory-level} w-event $\eps_w$-Geo-I thật ---
  đổi một phần sức chống-averaging thực nghiệm lấy một guarantee hợp lệ trên cả
  chuỗi.
\end{itemize}
...
\begin{enumerate}
  ...
  tư (Mục~\ref{sec:rem}, \ref{sec:trem}, \ref{sec:smrem}, \ref{sec:prsmrem});

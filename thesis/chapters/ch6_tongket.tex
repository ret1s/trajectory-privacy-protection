...
\begin{enumerate}
  ...
  \item Metric co giãn theo ngữ nghĩa trên đồ thị đường (``elastic GG-I''), kết
  hợp \cite{chatzikokolakis2015elastic} với \cite{takagi2019geo} --- một hướng ít
  được khai thác (không tuyên bố tuyệt đối ``chưa ai làm'' khi chưa có khảo sát
  hệ thống);
  \item So sánh thực thi có căn chỉnh (aligned) với các defense chống
  long-term-observation gần nhất --- Memoization/Replay/Replication của
  Simitçioğlu \& Gürsoy (Computer Networks 2026) và GEM/PTPPM/Eclipse --- để định
  vị đóng góp là \emph{tích hợp trong metric-space đường}, không phải phát minh
  memoization/reuse.
\end{enumerate}

"""Iteration 8: exactly matched tight privacy-budget bound."""
...
OUT=ROOT/'artifacts/benchmarks/research_loop/iteration08_matched.json'
...
def main():
    ...
    result={'schema':'whole-session-matched-bound-development-v1','resources':metadata,'dataset_sha256':sha(DATA),

"""Twelve fixed additional development families, never final confirmation."""
import argparse
...
OUTPUT = ROOT/'artifacts/datasets/research_loop_expanded_v1'
SPLITS = {s: 'expanded_development' for s in range(701,713)}


def build(output=OUTPUT, work=ROOT/'cache/research_loop_20260924/expanded_simulations'):
    ...
    sources={'experiments/build_research_loop_expanded.py','experiments/build_research_loop_dataset.py','data/scenario_suite_v2/design.py',
        'data/scenario_suite_v2/records.py','data/scenario_suite/mobility.py',
        'data/scenario_suite/records.py','data/sumo_demo.py'}
    bundle={'schema':SCHEMA,'purpose':'expanded_development_only; fixed shortlist screening, not final confirmation',
...
if __name__ == '__main__':
    ...
    p.add_argument('--workdir', type=Path, default=ROOT/'cache/research_loop_20260924/expanded_simulations')

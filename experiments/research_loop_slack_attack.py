"""Refit fixed sequence attackers to paced/slack public transcripts."""
...
SHADOW = ROOT/'artifacts/benchmarks/research_loop/paced_slack_shadows'
CORE = ROOT/'artifacts/benchmarks/research_loop/iteration17_paced_slack_cases.json'
DATA = ROOT/'artifacts/datasets/research_loop_development_v1/dataset.json'
OUT = ROOT/'artifacts/benchmarks/research_loop/iteration18_slack_attacks.json'

"""Build six new SUMO families, rare-POI and multi-day destination controls."""
import argparse
...
BASE=ROOT/'artifacts/datasets/urban_scenarios_v1/dataset.json'
LANE=ROOT/'artifacts/benchmarks/lane_comparison/results.json'
SPLITS={101:'development_train',102:'development_train',
        103:'development_validation',104:'development_validation',
        105:'confirmation',106:'confirmation'}
...
def build(output,work):
    ...
    sources=set(old['source_sha256']) | {'evaluation/scenario_metrics.py',
            'thesis/notes/belief_suite_v2_protocol.md','experiments/build_scenario_suite_v2.py'}
...
if __name__=='__main__':
    ...
    parser.add_argument('--output',type=Path,default=ROOT/'artifacts/datasets/urban_scenarios_v2')
    parser.add_argument('--workdir',type=Path,default=ROOT/'cache/scenario_suite_v2')

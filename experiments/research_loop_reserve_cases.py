"""Development ablation: reserve-aware pacing, with and without fixed .03 slack."""
...
OUT = ROOT/'artifacts/benchmarks/research_loop/iteration19_reserve_cases.json'
...
def main():
    ...
    result = {'schema': 'reserve-paced-case-development-v1',
        'scope': 'same L10 service, top-five target and epsilon; remaining-budget read pacing; development, matched attacks required',
        ...
        'code_sha256': sha(Path(__file__)), 'source_sha256': {p: sha(ROOT/p) for p in (
            ...
            'benchmark/engines/slack_progress.py', 'benchmark/engines/reserve_paced.py',

"""Independent v2 gates and native SUMO replay, without invoking the builder."""
import argparse
...
DEFAULT=ROOT/'artifacts/datasets/urban_scenarios_v2/dataset.json'
...
def verify_new_gates(data):
    ...
    assert {f['seed']:f['split'] for f in data['families']}=={
        ...
        104:'development_validation',105:'confirmation',106:'confirmation'}

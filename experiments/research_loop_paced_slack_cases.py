"""Development ablation: fixed .03 planning slack with top-L and public pacing."""
...
OUT = ROOT/'artifacts/benchmarks/research_loop/iteration17_paced_slack_cases.json'
CONTROLS = ('raw', 'filter_paced', 'response_paced')
...
def main():
    ...
    result = {'schema': 'paced-response-slack-case-development-v1',
        'scope': 'same L10 service and true top-five; .03 protected-belief planning slack; development; matched sequence attacks required',
        ...
        'code_sha256': sha(Path(__file__)), 'source_sha256': {p: sha(ROOT/p) for p in (
            ...
            'benchmark/engines/slack_progress.py',

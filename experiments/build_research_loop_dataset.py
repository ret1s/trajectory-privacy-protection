"""New development families on the recovered OSM snapshot; historical inputs untouched."""
import argparse
...
OUTPUT = ROOT/'artifacts/datasets/research_loop_development_v1'
SPLITS = {501:'development_train',502:'development_train',601:'development_validation',602:'development_validation'}


def build(output=OUTPUT, work=ROOT/'cache/research_loop_20260924/simulations'):
    ...
    sources={'experiments/build_research_loop_dataset.py','data/scenario_suite_v2/design.py',
        'data/scenario_suite_v2/records.py','data/scenario_suite/mobility.py',
        'data/scenario_suite/records.py','data/sumo_demo.py'}
    bundle={'schema':SCHEMA,'purpose':'development_only_new_OSM; no confirmation yet',
...
if __name__ == '__main__':
    ...
    p.add_argument('--workdir', type=Path, default=ROOT/'cache/research_loop_20260924/simulations')

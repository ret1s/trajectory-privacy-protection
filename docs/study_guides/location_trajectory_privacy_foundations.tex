...
Trong \code{docs/internship\_2.pdf}, phần liên quan Chow--Mokbel nằm ở physical
...
\begin{warningbox}[Sửa bibliography khi cập nhật thesis]
Entry cũ \code{chow2011trajectory} trong \code{thesis/refs.bib} đang ghi

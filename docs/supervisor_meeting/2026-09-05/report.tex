...
Trong quy trình thực thi hiện tại, ba phương pháp trên được tổ chức thành các \textbf{bản thích nghi có ánh xạ nguồn}: mỗi thành phần đã cài, đã thay thế hoặc còn thiếu đều được ghi trong thẻ phương pháp cùng phiên bản kho nguồn. Quy trình sẽ dừng nếu người chạy yêu cầu nhãn ``tái hiện SOTA'' trong khi một thành phần cốt lõi còn thiếu. Do đó, kết quả hiện tại chỉ chứng minh tính chạy được và tính đúng của giao diện; chưa được dùng để xếp hạng phương pháp trong luận văn.

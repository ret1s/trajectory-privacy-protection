...
> **Kết quả khảo sát ngày 01/09/2026:** chọn **SUMO** làm movement engine trên OSM; dùng **OMoSim** như demand generator tùy chọn cho multi-day activity/population; tự xây lớp Python cho scenario, query, group, protection, attack và metrics. Không tool nào tự cover toàn bộ S1--S7, nhưng hiện chưa cần viết cả trajectory simulator từ đầu. Ma trận coverage, kiến trúc dữ liệu và tiêu chí dừng được ghi tại [simulation_backtest_feasibility.md](simulation_backtest_feasibility.md).

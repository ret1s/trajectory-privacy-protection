...
**Phạm vi:** các scenario S1--S7 trong [kế hoạch nghiên cứu](research_plan.md), các mô hình dummy-generation đã chọn ở Mục 6, và hệ thống backtest hiện có trong repository.
